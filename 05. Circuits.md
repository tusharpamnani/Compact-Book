...
> **Examples:** [05.01 Basic Circuits](../examples/05.01.circuits.compact) · [05.02 Generics](../examples/05.02.generics.compact) · [05.03 Control Flow](../examples/05.03.control-flow.compact)
...
- **Previous:** [Ledger State](./04.%20Ledger%20State.md)  Public state model
- **Next:** [Witnesses](./06.%20Witnesses.md)  How private inputs enter circuits
- **See also:** [What is Compact](./00.%20What%20is%20Compact.md)  Compilation overview
- **See also:** [Explicit Disclosure](./07.%20Explicit%20Disclosure.md)  Privacy boundary
- **Examples:** [05.01 Basic Circuits](../examples/05.01.circuits.compact) · [05.02 Generics](../examples/05.02.generics.compact) · [05.03 Control Flow](../examples/05.03.control-flow.compact)