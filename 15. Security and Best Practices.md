...
> **Examples:** [15.01 Hash Auth](../examples/15.01.hash-auth.compact) · [15.02 Merkle Auth](../examples/15.02.merkle-auth.compact) · [15.03 Nullifier](../examples/15.03.nullifier.compact)
...
- **Previous:** [Testing and Debugging](./14.%20Testing%20and%20Debugging.md)  Version management
...
- **See also:** [Standard Library](./10.%20Standard%20Library.md)  Hash functions
- **See also:** [Example Projects](./16.%20Example%20Projects.md)  Working contracts
- **Examples:** [15.01 Hash Auth](../examples/15.01.hash-auth.compact) · [15.02 Merkle Auth](../examples/15.02.merkle-auth.compact) · [15.03 Nullifier](../examples/15.03.nullifier.compact)