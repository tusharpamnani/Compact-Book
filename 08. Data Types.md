...
> **Examples:** [08.01 Primitives](../examples/08.01.primitives.compact) · [08.02 Composites](../examples/08.02.composites.compact)
...
- **Previous:** [Explicit Disclosure](./07.%20Explicit%20Disclosure.md)  Disclosure boundary
- **Next:** [Ledger ADTs](./09.%20Ledger%20ADTs.md)  Collection types for ledger state
- **See also:** [Standard Library](./10.%20Standard%20Library.md)  Built-in types
- **Examples:** [08.01 Primitives](../examples/08.01.primitives.compact) · [08.02 Composites](../examples/08.02.composites.compact)