...
> **Examples:** [09.01 ADTs](../examples/09.01.adts.compact) · [09.02 Merkle Trees](../examples/09.02.merkle.compact) · [09.03 Kernel](../examples/09.03.kernel.compact)
...
- **Previous:** [Data Types](./08.%20Data%20Types.md) — Type system
- **Next:** [Standard Library](./10.%20Standard%20Library.md) — Hashing and token functions
- **See also:** [Ledger State](./04.%20Ledger%20State.md) — Commitment patterns
- **See also:** [Standard Library](./10.%20Standard%20Library.md) — Merkle tree functions
- **Examples:** [09.01 ADTs](../examples/09.01.adts.compact) · [09.02 Merkle Trees](../examples/09.02.merkle.compact) · [09.03 Kernel](../examples/09.03.kernel.compact)